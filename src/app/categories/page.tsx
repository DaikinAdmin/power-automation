...
// import { Item, CartItemType, Category } from '@/helpers/types/item';
...
//   const [searchResults, setSearchResults] = useState<SearchResults>({ items: [], categories: [], subCategories: [] });
...
//   useEffect(() => {
//     applyFilters();
//   }, [items, selectedBrands, selectedWarehouses, selectedSubcategories, selectedCategories, sortBy]);

//   useEffect(() => {
//     if (searchQuery) {
//       performSearch(searchQuery);
//     } else {
//       setSearchResults({ items: [], categories: [], subCategories: [] });
//     }
//   }, [searchQuery]);
